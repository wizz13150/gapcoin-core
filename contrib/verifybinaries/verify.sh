...
RCSUBDIR="test"
HOST1="https://gapcoincore.org"
HOST2="https://gapcoin.org"
BASEDIR="/bin/"
VERSIONPREFIX="gapcoin-core-"
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Gapcoin Core binary release signing key installed?"
   fi
