...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s gapcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gapcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gapcoin transaction") + "\n" +
              "  gapcoin-tx [options] -create [commands]   " + _("Create hex-encoded gapcoin transaction") + "\n" +
              "\n";
